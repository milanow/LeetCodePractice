 ...
 * This solution is comming from Leetcode Forum.
 * The key is to maintain a list of buckets where a bucket represents set of keys
 * with same value. To keep the buckets sorted, we need to create buckets carefully
 * The final buckets should be continuous value-buckets from 1 to n
 */
